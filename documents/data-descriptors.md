...
| Data initialization | `A.P.E.X/src/main/java/io/github/strmckr/apex/generator/DataInitializer.java` |
| MSD descriptors | `A.P.E.X/src/main/java/io/github/strmckr/apex/msd/MsdBucketPlanner.java` |
| MSD scatter offsets | `A.P.E.X/src/main/java/io/github/strmckr/apex/scatter/Scattered.java` |
| LSD cycle planning | `A.P.E.X/src/main/java/io/github/strmckr/apex/lsd/LsdBucketPlan.java` |
| Tuple projection | `A.P.E.X/src/main/java/io/github/strmckr/apex/tuples/Tuples.java` |
| Tiny routes | `A.P.E.X/src/main/java/io/github/strmckr/apex/tinysorts/TinySort.java` |
