...
StrmCkr
June 3, 2026
Draft PDF artifact: [A_P_E_X.pdf](A_P_E_X.pdf)
```
...
| --- | --- |
| Main pipeline | `A.P.E.X/src/main/java/io/github/strmckr/apex/engine/ApexEngine.java` |
| Public API | `A.P.E.X/src/main/java/io/github/strmckr/apex/Apex.java` |
| Public configuration | `A.P.E.X/src/main/java/io/github/strmckr/apex/Configuration.java` |
| Runtime options | `A.P.E.X/src/main/java/io/github/strmckr/apex/config/RunOptions.java` |
| Sort configuration model | `A.P.E.X/src/main/java/io/github/strmckr/apex/config/SortConfig.java` |
| Configuration defaults | `A.P.E.X/src/main/java/io/github/strmckr/apex/config/Configurations.java` |
| Auto tuning | `A.P.E.X/src/main/java/io/github/strmckr/apex/tuning/AutoTuner.java` |
| MSD planning | `A.P.E.X/src/main/java/io/github/strmckr/apex/msd/MsdBucketPlanner.java` |
| Parallel scatter | `A.P.E.X/src/main/java/io/github/strmckr/apex/scatter/Scattered.java` |
| LSD work planning | `A.P.E.X/src/main/java/io/github/strmckr/apex/lsd/LsdBucketPlan.java` |
| Tuple projection | `A.P.E.X/src/main/java/io/github/strmckr/apex/tuples/Tuples.java` |
| Tiny sort routes | `A.P.E.X/src/main/java/io/github/strmckr/apex/tinysorts/TinySort.java` |
| Verification | `A.P.E.X/src/main/java/io/github/strmckr/apex/tools/Verifier.java` |
| Data modes | `A.P.E.X/src/main/java/io/github/strmckr/apex/generator/DataMode.java` |
